...
classes = {
        "City": City, "State": State, "User": User, "Place": Place,
        "Review": Review, "Amenity": Amenity}


class DBStorage:
    """A storage class that manages hbnb models in JSON a relational DB"""
    __engine = None
    __session = None

    def __init__(self):
        """Instantiates an instance of the DBStorage"""
        dialect = "mysql"
        driver = "mysqldb"
        port = 3306
    ...
    def save(self):
        """finalizes the changes made to the storage"""
